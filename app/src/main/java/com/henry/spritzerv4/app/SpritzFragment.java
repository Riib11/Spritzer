...
import pro.dbro.openspritz.AppSpritzer;
...
//        mProgress = ((ProgressBar) root.findViewById(R.id.progress));
        ...
        Button mButtonReset = (Button) root.findViewById(R.id.buttonReset);
        ...
        Button mButtonReadOCR = (Button) root.findViewById(R.id.buttonReadOCR);
        mButtonReadOCR.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                    ...
                    FileInputStream fis = getActivity().openFileInput("result.txt");
                    ...
                    mSpritzer.setTextAndStart(contents.toString());
                } catch( Throwable ex) {
                    mSpritzer.setTextAndStart("Error loading content: " + ex.toString());
                }
            }
        });
        return root;
